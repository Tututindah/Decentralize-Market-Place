        ...
        <div className={`min-h-screen ${rootClass} transition-colors flex flex-col`}>
            ...
            <div className="flex-grow">
                <div className="max-w-7xl mx-auto px-4 py-8">
                    <Button variant="ghost" onClick={onBack} className={`mb-6 ${isDarkMode ? 'text-white hover:bg-zinc-800' : 'text-black hover:bg-gray-100'}`}>
                    ...
                    <section className="space-y-12">
                        <div className={`p-6 rounded-xl transition-colors ${isDarkMode ? 'bg-zinc-900 border-2 border-zinc-800' : 'bg-white border-2 border-gray-200'}`}>
