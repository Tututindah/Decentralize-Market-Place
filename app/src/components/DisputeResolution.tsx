        ...
        <Card className={`p-6 ${cardClass} space-y-6 shadow-xl`}>
          ...
          {disputeStep === 'pending' && (
            <div className="space-y-6">
              ...
              <div className={`p-4 rounded-lg ${isDarkMode ? 'bg-zinc-800 border border-zinc-700' : 'bg-white border border-gray-200'}`}>
                  ...
                  {juryVotes.map((j, index) => (
                    <li key={j.id} className="flex items-center justify-between">
                      ...
                      <Badge 
                        ...
                        className={`w-20 justify-center capitalize ${j.vote === 'employer' && 'bg-red-500 hover:bg-red-500'} ${isDarkMode ? '' : 'text-black border-gray-300'}`}
                      >
              ...
              <Button variant="outline" onClick={onBack} className={`w-full ${isDarkMode ? 'border-zinc-700 hover:bg-zinc-800' : 'border-gray-300 hover:bg-gray-200'}`}>
                Back to Job
              </Button>
            </div>
          )}
