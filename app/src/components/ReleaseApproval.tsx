      ...
      <div className="flex-grow max-w-xl mx-auto px-4 py-8 w-full">
        ...
        <Card className={`p-6 ${cardClass} space-y-6 shadow-xl`}>
          ...
          <div className="space-y-4">
            ...
            <Button variant="outline" className={`w-full ${isDarkMode ? 'border-zinc-700 hover:bg-zinc-800' : 'border-gray-300 hover:bg-gray-200'}`}>
            ...
            {!showReview ? (
              ...
              <>
                ...
                <div className="flex gap-3">
                  ...
                  <Button variant="outline" onClick={() => setShowReview(false)} className={isDarkMode ? 'border-zinc-700 hover:bg-zinc-800' : 'border-gray-300 hover:bg-gray-200'}>
                    Cancel
                  </Button>
                </div>
              </>
